...
Pour commencer, il est important de télécharger les données que nous utiliserons pour ce travail. Ceux-ci proviennent de deux source différente et nous avions certaine condition a respecter. Nous devions télécharger les données avec un certain cycle. Pour faire cela nous avons créer une fonction qui demande la récurence des téléchargements, le nom que l'on veut donner au document et l'url du document. Pour les données provenent de Our World in Data^1^ , il a été simple de les télécharger via la fonction. Ce qui n'a pas été le cas avec la seconde base de donnée Gapminder^2^ qui sont sous format .xlsx, mais surtout qui n'a visiblement pas d'url de téléchargement fonctionnel sans l'implication humaine.

Ainsi, la suite du travail consiste en \['exploration des données et de l'analyse de ceux-ci
